...
DATASET_NAMES = ucr_dataset_list()
...
from pyts.datasets import ucr_dataset_list
UNIVARIATE_DATASET_NAMES = ucr_dataset_list()
...
def read_dataset(root_dir, dataset_name):
    ...
    file_name = root_dir + '/Data/'  + dataset_name + '/' + dataset_name
...
def read_all_datasets(root_dir):
    ...
    for dataset_name in DATASET_NAMES:
        ...
        file_name = root_dir_dataset + dataset_name + "/" + dataset_name
...
def generate_results_csv(output_file_name, root_dir, clfs):
    ...
    for classifier_name in clfs:
        ...
        for dataset_name in datasets_dict.keys():
            output_dir = root_dir + '/results/' + classifier_name + '/'  + '/' + dataset_name + '/' + 'df_metrics.csv'
            print(output_dir)
